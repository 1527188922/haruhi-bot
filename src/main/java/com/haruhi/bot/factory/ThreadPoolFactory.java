...
//    private static ScheduledThreadPoolExecutor scheduledThreadPool = null;
    ...
    private final static Executor chatHistoryThreadPool = new ThreadPoolExecutor(1,1,30, TimeUnit.MINUTES,new ArrayBlockingQueue(15),new CustomizableThreadFactory("pool-chat-history-"),new ThreadPoolExecutor.CallerRunsPolicy());
